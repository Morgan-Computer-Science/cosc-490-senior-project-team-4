...
#prototype: Vertex AI studio 
#vertex AI Agent Builder
#GEmini Based models
#Gihub CS chatbot for a chatbot
#Gemini for prompting, testing and documentation
#containeriEd it using docker and deploy in the cloud
